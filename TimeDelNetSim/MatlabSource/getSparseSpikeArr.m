...
% Get Unique NStart GenTimePairs
GenNStart = InputStruct.NStart(SpikeSynIndVect);
[~, Inds] = unique([GenNStart, GenerationTimeVect], 'rows');

SparseSpikeMat = sparse(...
	double(GenNStart(Inds)),  ...
	GenerationTimeVect(Inds)-BegTime+1, ...
	1, ...
