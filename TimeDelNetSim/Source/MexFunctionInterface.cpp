...
void takeInputFromMatlabStruct(mxArray* MatlabInputStruct, InputArgs &InputArgList){
	...
	getInputfromStruct<float>(MatlabInputStruct, "IinMax"            , InputArgList.IinMax            );
...
mxArray * putInputStatetoMatlabStruct(InputArgs &InputStateStruct){
	...
	mxSetField(ReturnPointer, 0, "IinMax"              , assignmxArray(InputStateStruct.IinMax              , mxSINGLE_CLASS));
